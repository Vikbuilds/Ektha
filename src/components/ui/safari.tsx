...
export function Safari({
  ...
  const hasMedia = hasVideo || !!imageSrc || !!imageSrcLight || !!imageSrcDark
  ...
  return (
    ...
    >
      ...
      {!hasVideo && (imageSrcLight || imageSrcDark) && (
        <>
          {imageSrcLight && (
            <div
              className="pointer-events-none absolute z-0 overflow-hidden dark:hidden"
              style={{
                left: `${LEFT_PCT}%`,
                top: `${TOP_PCT}%`,
                width: `${WIDTH_PCT}%`,
          ...
          {imageSrcDark && (
            <div
              className="pointer-events-none absolute z-0 overflow-hidden hidden dark:block"
              style={{
                left: `${LEFT_PCT}%`,
                top: `${TOP_PCT}%`,
                width: `${WIDTH_PCT}%`,
      ...
      {!hasVideo && !imageSrcLight && !imageSrcDark && imageSrc && (
        <div
          className="pointer-events-none absolute z-0 overflow-hidden"
          style={{
            left: `${LEFT_PCT}%`,
